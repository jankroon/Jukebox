...
# Extended Class, Subclass, Inheritance
class JukeboxDeLuxe(Jukebox):
    "Extension of Python Class Jukeboxthat can play more popular tunes"

    def __init__(self, name): # This is called a constructor method
        Jukebox.__init__(self, name)
        
    def playOODenHaag(self):
        if self.credits > 0:
            self.credits = self.credits - 1
            print("O, O Den Haag")
            print("Mooie stad achter de duinen")
        else:
            print("First insert coins, please!")
    ...
    def playSinatraTune(self):
        if self.credits > 0:
            ...
            print("I like to wake up in a city that never sleeps!")
        else:
            print("First insert coins, please!")

jbdl = JukeboxDeLuxe("Wurlitzer De Luxe")
